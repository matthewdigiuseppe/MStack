---
name: cover-letter
description: Drafts a cover letter to a chosen journal and editor. Use after journal-fit.
user-invocable: true
allowed-tools:
  - Read
  - Write
...
Drafts a cover letter to a chosen journal and editor. Use after journal-fit.

## Forcing questions / body

One paragraph: what the paper does and why it fits this journal. One paragraph: contribution. One paragraph: declarations (preregistration, data, conflicts). Keep it under 400 words.
