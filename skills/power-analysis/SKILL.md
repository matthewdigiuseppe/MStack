...
5. **Report** to `.mstack/power-analysis.md`: inputs with justifications; method (analytic vs. simulation, software, seed); results table (target N, MDE at planned N, power at expected effect, ICC / attrition assumed); the curve; **verdict** — can the planned N detect the effect of substantive interest? If not, larger N or redesign.
