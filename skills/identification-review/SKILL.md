...
description: Methodologist voice — threats to inference, alternative explanations, what would change your mind. Analog to gstack's /plan-eng-review.
user-invocable: true
allowed-tools:
  - Read
  - Write
...
Methodologist voice — threats to inference, alternative explanations, what would change your mind. Analog to gstack's /plan-eng-review.

## Forcing questions / body

What is the identifying assumption? What is the most plausible violation? What is the placebo / falsification test? What would change your mind?
