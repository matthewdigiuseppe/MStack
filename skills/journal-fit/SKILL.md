---
name: journal-fit
description: Picks 3 target journals and drafts a comparison table (impact × fit × turnaround). Use when a paper is submission-ready.
user-invocable: true
allowed-tools:
  - Read
  - Write
...
Picks 3 target journals and drafts a comparison table (impact × fit × turnaround). Use when a paper is submission-ready.

## Forcing questions / body

Why each journal? Recent papers in the same conversation? Editor preferences? Realistic turnaround? Risk of desk reject? Tier the three.
